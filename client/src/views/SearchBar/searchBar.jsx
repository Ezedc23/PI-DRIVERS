...
function SearchBar({ onSearch, isChecked, handleCheckboxChange }) {
	// Recibe el estado del checkbox y la función de cambio como props
	...
	return (
		<div className={styles["search-container"]}>
			<form className={styles["search-box"]}>
				...
				{/*BOTON DE BUSCAR */}
				<button className={styles["buttonLink"]} onClick={handleSearch}>
					<span
				...
				<label
					...
					title="If enabled it searches all pilots, and ignores currently applied filters."
				>
					<input
						checked={isChecked}
