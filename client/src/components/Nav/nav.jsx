...
function Nav({
	...
	); // Usamos localStorage para mantener el estado del checkbox
	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.searchContainer}>
				...
				/>{" "}
				{/* Pasamos el estado del checkbox y la función de cambio como props */}
			</div>
			...
			<button
				...
				onClick={handleReset}
				title="All filters and sorts will be initialized, showing all drivers."
			>
				<span>Reset</span>
			</button>
			...
			<select
				...
				title="It may be sorted Ascending or Descending by forename, in addition to being able to sort by dob"
			>
			...
			<select
				onChange={handlerFilterTeam}
				value={selectedTeam}
				className={styles.selectTeam}
				title="You can filter the drivers according to the team they belong to."
			>
			...
			<select
				...
				title="You can filter according to the origin of the data, if they come from the DB or from the API."
			>
